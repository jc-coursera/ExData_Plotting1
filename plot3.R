#----------------------------------------------------------------------------------
# plot3.R : Plot 3 Energy sub meterings vs Datetime
#----------------------------------------------------------------------------------
...
with(plot_data, {
    ...
    legend("topright",lty=1,cex=0.6,y.intersp=0.5, col=c("black","red","blue"), legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"))
})

# Create PNG file
dev.copy(png,'./ExploratoryAnalysis/plot3.png')
dev.off()
